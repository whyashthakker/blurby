...
const comparison = {
  ...
  competitor: {
    name: "Blinqo",
    tagline: "Simple screen blur extension",
    pros: [
      "One-click element blur",
      "Blur area drawing tool",
      "Text selection blur",
      "Input field blur option",
      "Persist blur feature",
      "Free to use"
    ],
    cons: [
      "No AI detection",
...
export default function BlurbyVsBlinqo() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-16 pt-32">
        ...
        <h1 className="text-4xl font-cal mb-4">
          Blurby vs Blinqo: Complete Comparison
        </h1>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          See how Blurby's comprehensive AI features compare to Blinqo's basic free solution
        </p>
        </div>
            ...
            <table className="w-full">
              <thead className="bg-muted/50">
                <tr>
                  ...
                  <th className="text-center p-4 font-cal">Blinqo</th>
                </tr>
              </thead>
              <tbody className="divide-y">
                ...
                <tr>
                  <td className="p-4 font-medium">Blur Area Drawing</td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                </tr>
                <tr>
                  <td className="p-4 font-medium">Text Selection Blur</td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                </tr>
                <tr>
      ...
      <div className="text-center mt-16">
        <h2 className="text-2xl font-cal mb-4">Professional vs Basic</h2>
        <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
          While Blinqo offers basic functionality for free, Blurby provides professional-grade features with AI automation for serious content creators.
        </p>
