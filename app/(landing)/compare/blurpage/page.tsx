...
const comparison = {
  ...
  competitor: {
    name: "Blur.page",
    tagline: "Simple element blurring",
    pros: [
      "Magic icon hover blur",
      "Element hiding by click",
...
export default function BlurbyVsBlurPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-16 pt-32">
        ...
        <h1 className="text-4xl font-cal mb-4">
          Blurby vs Blur.page: Complete Comparison
        </h1>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Compare Blurby's AI automation with Blur.page's simple manual approach
        </p>
        </div>
            ...
            <table className="w-full">
              <thead className="bg-muted/50">
                <tr>
                  ...
                  <th className="text-center p-4 font-cal">Blur.page</th>
                </tr>
              </thead>
              <tbody className="divide-y">
                ...
                <tr>
                  <td className="p-4 font-medium">Magic Icon Hover</td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                </tr>
                <tr>
                  <td className="p-4 font-medium">Adjustable Blur Levels</td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                </tr>
                <tr>
                  <td className="p-4 font-medium">Reload Persistence</td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                </tr>
                <tr>
                  <td className="p-4 font-medium">Automatic Sensitive Data Detection</td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                  <td className="p-4 text-center"><X className="w-5 h-5 text-red-600 mx-auto" /></td>
                </tr>
                <tr>
                  <td className="p-4 font-medium">Professional Features</td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                  <td className="p-4 text-center"><X className="w-5 h-5 text-red-600 mx-auto" /></td>
                </tr>
                <tr>
      ...
      <div className="text-center mt-16">
        <h2 className="text-2xl font-cal mb-4">Upgrade to Professional</h2>
        <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
          While Blur.page provides basic functionality, Blurby offers comprehensive AI-powered protection for professional content creators and developers.
        </p>
