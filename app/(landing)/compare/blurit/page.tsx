...
import { Check, X, Zap, Shield, Eye, MousePointer, Settings } from "lucide-react"
...
const comparison = {
  ...
  competitor: {
    name: "BlurIt",
    tagline: "Basic element blurring",
    pros: [
      "Simple one-click element blur",
      "Free to use",
      "Works with major browsers",
      "Basic blur intensity control"
    ],
    cons: [
      "No AI detection",
      "Manual selection required",
      "Limited blur persistence",
      "No custom area support",
      "Basic feature set",
...
export default function BlurbyVsBlurIt() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-16 pt-32">
        ...
        <h1 className="text-4xl font-cal mb-4">
          Blurby vs BlurIt: Complete Comparison
        </h1>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          See how Blurby's AI-powered privacy protection compares to BlurIt's basic blurring features
        </p>
        </div>
            ...
            <table className="w-full">
              <thead className="bg-muted/50">
                <tr>
                  ...
                  <th className="text-center p-4 font-cal">BlurIt</th>
                </tr>
              </thead>
              <tbody className="divide-y">
                ...
                <tr>
                  <td className="p-4 font-medium">One-Click Element Blur</td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                </tr>
                <tr>
                  <td className="p-4 font-medium">Custom Blur Areas</td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                  <td className="p-4 text-center"><X className="w-5 h-5 text-red-600 mx-auto" /></td>
                </tr>
                <tr>
                  <td className="p-4 font-medium">Persistent Blur Settings</td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                  <td className="p-4 text-center"><X className="w-5 h-5 text-red-600 mx-auto" /></td>
                </tr>
                <tr>
                  <td className="p-4 font-medium">Zero Latency</td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                  <td className="p-4 text-center"><X className="w-5 h-5 text-red-600 mx-auto" /></td>
                </tr>
                <tr>
                  <td className="p-4 font-medium">Privacy-First Architecture</td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                </tr>
                <tr>
      ...
      <div className="text-center mt-16">
        <h2 className="text-2xl font-cal mb-4">Ready to upgrade your privacy?</h2>
        <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
          Join thousands of professionals who choose Blurby for advanced AI-powered privacy protection
        </p>
