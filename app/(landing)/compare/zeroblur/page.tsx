...
const comparison = {
  ...
  competitor: {
    name: "ZeroBlur",
    tagline: "Free browser extension",
    pros: [
      "Completely free",
      "Multi-browser support (Chrome, Firefox, Edge)",
      "Element and area blur options",
      "Site-wide blur settings",
      "Basic blur persistence"
    ],
    cons: [
      "No AI detection",
...
export default function BlurbyVsZeroBlur() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-16 pt-32">
        ...
        <h1 className="text-4xl font-cal mb-4">
          Blurby vs ZeroBlur: Complete Comparison
        </h1>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Compare Blurby's advanced AI features with ZeroBlur's free manual blurring solution
        </p>
        </div>
            ...
            <table className="w-full">
              <thead className="bg-muted/50">
                <tr>
                  ...
                  <th className="text-center p-4 font-cal">ZeroBlur</th>
                </tr>
              </thead>
              <tbody className="divide-y">
                ...
                <tr>
                  <td className="p-4 font-medium">Automatic Recognition</td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                  <td className="p-4 text-center"><X className="w-5 h-5 text-red-600 mx-auto" /></td>
                </tr>
                <tr>
                  <td className="p-4 font-medium">Drag & Drop Areas</td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                </tr>
                <tr>
                  <td className="p-4 font-medium">Site-wide Settings</td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                  <td className="p-4 text-center"><Check className="w-5 h-5 text-green-600 mx-auto" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="p-4 text-center text-sm">Chrome, Edge</td>
                  <td className="p-4 text-center text-sm">Chrome, Firefox, Edge</td>
                </tr>
                <tr>
      ...
      <div className="text-center mt-16">
        <h2 className="text-2xl font-cal mb-4">Why Choose Blurby?</h2>
        <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
          While ZeroBlur offers basic free functionality, Blurby provides professional-grade AI-powered protection for serious content creators and professionals.
        </p>
